...
prevent_mash_buffer--;
if (pinkballoonid != -1 && pinkballoonid.sprite_index == 3811)
{
...
for (n = 1; n < pos; n += 1)
{
    ...
    else if (mychar == "\\")
    {
        ...
        if (nextchar == "f" && faced == 0)
        {
            ...
            {
                global.sminstance[fam] = instance_create(global.smxx[fam], global.smyy[fam], 1175);
        ...
        if (nextchar == "*")
        {
            ...
            var __y = 0;
            if (global.chapter == 5 && i_ex(579) && i_ex(1531) && obj_battleblcon.flowery_float == true)
            {
                __y = sin(obj_flowery_enemy.float_siner * 0.33) * 5;
            }
            draw_sprite_ext(_sprite, 0, wx + x_offset, wy + 2 + y_offset + __y, 2, 2, 0, 16777215, 1);
            if (_sprite == 4817)
            {
                wx += 8;
            }
            if (global.lang == "ja")
            {
                if (_sprite == 4971 || _sprite == 4973 || _sprite == 4966 || _sprite == 4970 || _sprite == 4461 || _sprite == 8081 || _sprite == 327 || _sprite == 4799)
                {
                    wx += 4;
                }
            }
        ...
        if (nextchar == "C")
        {
            if (nextchar2 == "1")
            {
                if (instance_exists(1170) == false)
                {
                    choicer = instance_create(0, 0, 1170);
                }
                halt = 5;
            }
            if (nextchar2 == "2" || nextchar2 == "3" || nextchar2 == "4")
            {
                if (instance_exists(1171) == false)
                {
                    choicer = instance_create(0, 0, 1171);
    ...
    if (accept == 1)
    {
        ...
        var __x = 0;
        var __y = 0;
        if (global.chapter == 5 && i_ex(300) && obj_pink_enemy.idlesprite == 3505)
        {
        ...
        if (pinkballoonid != -1 && pinkballoonid.sprite_index == 1510)
        {
            if (i_ex(300) && obj_pink_enemy.idlesprite == 3505)
            {
            }
            else
            {
        ...
        if (global.chapter == 5 && i_ex(579) && i_ex(1531) && obj_battleblcon.sprite_index == 4086 && obj_battleblcon.auto_length == 1 && obj_battleblcon.side == -1)
        {
        ...
        if (global.chapter == 5 && i_ex(579) && i_ex(1531) && obj_battleblcon.flowery_aqua_float == true)
        {
        ...
        if (special >= 1)
        {
            if (special == 1)
            {
                if (draw_get_color() != 16777215 && draw_get_color() != 0)
                {
                    ...
                    draw_text_color(wx + random(shake), wy + random(shake), mychar, 16777215, 16777215, xcolor, xcolor, 1);
                }
                else
                {
                    draw_text_color(wx + random(shake) + 1, wy + random(shake) + 1, mychar, 4210752, 4210752, 8388608, 8388608, textalpha);
