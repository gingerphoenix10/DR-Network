...
for (var i = 0; i < _size; i++)
{
    ...
    var downgradePlayer = player.object_index == obj_plat_pvp_charafake && (!IsPVP() || player.roomin != room || player.eliminated || global.pvpeliminated);
    
    if (upgradeToEnemy)
    {
        var enemy = instance_create_depth(0, 0, -1000, obj_plat_pvp_charafake);
