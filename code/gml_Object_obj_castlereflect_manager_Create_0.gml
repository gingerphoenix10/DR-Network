...
reflectable_objects = [1198, 1660, 1389, 775, 1559, 512, 171, 373, 954, 1611, 1058, 309, 152, obj_charafake];
shadow_falloff = 160;
depth = 20000;
u_uvs = shader_get_uniform(48, "uvs");
u_falloff = shader_get_uniform(48, "shadowheight");
u_y = shader_get_uniform(48, "pos_y");
_cx = 0;
_cy = 0;
