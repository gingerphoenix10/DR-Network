...
if (drawchar == 1)
{
    ...
    if (deschaver == 0)
    {
        // Consoles will load a 6th menu option for Network as controllers don't have an "O" key
        ...
        {
            draw_sprite_ext(spr_deltanetwork, 0, xx + 158, (yy + tp) + 37, 1, 1, 0, c_white, 1);
        }
