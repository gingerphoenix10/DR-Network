buffer += 1;
var truename = global.truename;
if (global.mysteryin == "chapter4")
{
    truename = "=)";
}
if (global.interact == 5)
{
    xx = __view_get(UnknownEnum.Value_0, view_current);
    yy = __view_get(UnknownEnum.Value_1, view_current) + 10;
    moveyy = yy;
    ...
    if (global.menuno != 4)
    {
        ...
        {
            draw_text(23 + xx, 58 + moveyy, string_hash_to_newline(stringsetsubloc("G   ~1", string(global.lgold), "obj_overworldc_slash_Draw_0_gml_40_0")));
        }
        ...
        {
            draw_text(23 + xx, 20 + moveyy, string_hash_to_newline(truename));
        }
    ...
    if (global.menuno == 2)
    {
        ...
        {
            draw_text(108 + xx, 32 + yy, string_hash_to_newline(stringsetsubloc("\"~1\"", truename, "obj_overworldc_slash_Draw_0_gml_66_0")));
        }
        ...
        {
            weaponname = stringsetloc("Holiday Pencil", "obj_overworldc_slash_Draw_0_gml_83_0_b");
        }
        if (global.lweapon == 16)
        {
            weaponname = stringsetloc("CactusNeedle", "obj_overworldc_slash_Draw_0_gml_84_0");
        }
        if (global.lweapon == 17)
        {
            weaponname = stringsetloc("BlackShard", "obj_overworldc_slash_Draw_0_gml_85_0");
        }
        if (global.lweapon == 18)
        {
            weaponname = stringsetloc("QuillPen", "scr_litemname_slash_scr_litemname_gml_24_0");
        }
        if (global.larmor == 3)
        {
        ...
        {
            draw_text(108 + xx, 192 + yy, string_hash_to_newline(stringsetsubloc("GOLD: ~1", string(global.lgold), "obj_overworldc_slash_Draw_0_gml_83_0")));
        }
        ...
        else if (global.flag[914] > 0)
        {
            if (mysterycheck() == 1)
            {
                krispreservationsociety = stringsetsubloc("Since#Chapter ~1", global.flag[914], "obj_overworldc_slash_Draw_0_gml_95_0");
    ...
    if (global.menuno == 0)
    {
        draw_sprite(4862, 0, 28 + xx, 88 + yy + (18 * global.menucoord[0]));
    }
    if (global.menuno == 1)
    {
        draw_sprite(4862, 0, 104 + xx, 34 + yy + (16 * global.menucoord[1]));
    }
    if (global.menuno == 3)
    {
        draw_sprite(4862, 0, 104 + xx, 34 + yy + (16 * global.menucoord[3]));
    }
    if (global.menuno == 6)
    {
        draw_sprite(4862, 0, 104 + xx, 34 + yy + (16 * global.menucoord[6]));
    }
    if (global.menuno == 7)
    {
        draw_sprite(4862, 0, 104 + xx, 34 + yy + (16 * global.menucoord[7]));
    }
    if (global.menuno == 5)
    {
        if (global.menucoord[5] == 0)
        {
            draw_sprite(4862, 0, 104 + xx + (45 * global.menucoord[5]), 174 + yy);
        }
        if (global.menucoord[5] == 1)
        {
            draw_sprite(4862, 0, 104 + xx + ((45 * global.menucoord[5]) + 3), 174 + yy);
        }
        if (global.menucoord[5] == 2)
        {
            draw_sprite(4862, 0, 104 + xx + ((45 * global.menucoord[5]) + 15), 174 + yy);
        }
    }
}
