    ...
    for (c = 0; c < 4; c += 1)
    {
        if (havechar[c] == 1)
        {
            ...
            if (global.fighting == 1)
            {
                ...
                if (global.chapter == 5 && i_ex(579) && obj_flowery_enemy.flowerbuttonactive == true && c == 0)
                {
                    draw_sprite(6920, btc[1], xx + xchunk + 50 + icon_offset, (485 - bp) + yy);
                }
                else if (c == 0)
                {
                ...
                {
                    draw_sprite_ext(scr_84_get_sprite("spr_btspare"), 2, xx + xchunk + 120 + icon_offset, (485 - bp) + yy, 1, 1, 0, 16777215, 0.4 + (sin(global.time / 6) * 0.4));
                }
                if (pacify_glow == 1 && gc == charpos[c])
                {
                    draw_sprite_ext(scr_84_get_sprite("spr_bttech"), 2, xx + xchunk + 50 + icon_offset, (485 - bp) + yy, 1, 1, 0, 16777215, 0.4 + (sin(global.time / 6) * 0.4));
                }
            }
            if (gc == charpos[c])
            {
            ...
            if (c == 0)
            {
                if (soloflowery)
                {
                    ...
                    draw_sprite(7082, global.faceaction[charpos[c]], xx + 13 + xchunk, (bpoff + b_offset + mmy[c]) - 11);
                    draw_sprite(bname, 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
                }
                else
                {
                    draw_sprite(4138, global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                    draw_sprite(scr_84_get_sprite("spr_bnamekris"), 0, xx + 51 + xchunk, bpoff + b_offset + 3 + mmy[c]);
                }
            }
            if (c == 1)
            {
                draw_sprite(4145, global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
            ...
            if (c == 2)
            {
                if (haveflowery)
                {
                    ...
                    {
                        draw_sprite(7082, 0, xx + 240 + 198, (bpoff + b_offset + mmy[c]) - 11);
                    }
                    else
                    {
                        draw_sprite(4140, global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
                    }
                }
                else
                {
            ...
            if (c == 3)
            {
                draw_sprite(4146, global.faceaction[charpos[c]], xx + 13 + xchunk, bpoff + b_offset + mmy[c]);
            ...
            if (instance_exists(780) && c == 0)
            {
                maxhp = 90;
                hp = min(hp, maxhp);
            }
            draw_sprite(4148, 0, xx + 109 + xchunk, bpoff + b_offset + 11 + mmy[c]);
            ...
            draw_sprite(4149, 0, xx + 159 + xchunk, ((bpoff + b_offset) - 4) + mmy[c]);
