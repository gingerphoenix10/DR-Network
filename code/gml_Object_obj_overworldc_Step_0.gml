...
if (global.interact == 5)
{
    ...
    if (button1_p())
    {
        ...
        if (global.menuno == 3)
        {
            ...
            {
                script_execute(scr_litemuseb, global.menucoord[3], global.mysteryphone[global.menucoord[3]]);
            }
        }
        if (global.menuno == 1)
        {
        ...
        if (global.menuno == 3)
        {
            if (global.chapter == 4 && global.plot >= 67 && mysterycheck())
            {
                scr_speaker("no_name");
    ...
    if (down_p())
    {
        ...
        if (global.menuno == 3)
        {
            if (global.menucoord[3] != 7)
            {
                ...
                else if (global.mysteryphone[global.menucoord[3] + 1] != 0)
                {
                    global.menucoord[3] += 1;
                }
            }
...
if (global.menuno == 9 && instance_exists(400) == false)
{
    global.menuno = -1;
    global.interact = 0;
}
